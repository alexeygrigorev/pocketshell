...
# Issue #2562's session-memory-cap proof (scripts/check-cgroup-cap-proof.sh)
# was DELETED here (issue #2643): it drove the host CLI's pytest cgroup proof,
# and the CLI now lives in PocketShell-io/pocketshell-cli, whose CI owns the
# proof and its --if-supported hosting story.
