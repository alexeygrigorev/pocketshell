 ...
 * mismatch or downgrade path and crash on launch (#261). Bumped to 10 because
 * issue #294 removes the manual host PATH override column; bootstrap probes
 * now derive PATH from the user's remote shell rc.
 *
