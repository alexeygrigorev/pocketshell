 ...
 * (rewrite task P-3b; ported unchanged from the old client's `MarkdownModel`,
 * which the rewrite keeps because it is pure Kotlin with no dependency on the
 * deleted connection stack).
 *
