...
- CREATE: `app2/.../composer/ComposerViewModel.kt` NEW (≤400 lines) —
  ...
  Reconfirmed 2026-09-03: the job is sending ONE message reliably, not
  batching/queueing — resist any temptation, on this task or a later one,
  to grow this back toward retry/offline-delivery
