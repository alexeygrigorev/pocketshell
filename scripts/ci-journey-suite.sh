...
JOURNEY_CLASSES=(
  ...
  "com.pocketshell.app.composer.PromptComposerDraftLossOnFinalizeE2eTest"  # #1616 D33/G10: type a new draft while the previous send is in flight; finalize must preserve it and keep the real sheet open
