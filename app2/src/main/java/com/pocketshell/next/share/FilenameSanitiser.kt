...
/**
 * Filename sanitiser for the Android share-target upload path (rewrite task
 * P-9, ported from the shipping client's issue #138 implementation — the rules
 * below are transport-independent, so the port is verbatim apart from the
 * package).
 *
