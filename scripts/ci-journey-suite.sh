...
JOURNEY_CLASSES=(
  ...
  "com.pocketshell.app.projects.AgentStateReadBackDockerTest"  # #1237 agent-state chip read-back: stamps @ps_agent_state on the agents fixture, reads via listSessionsWithFolder, asserts idle/waiting resolve + stale/absent -> Unknown (no new port, no self-skip)
