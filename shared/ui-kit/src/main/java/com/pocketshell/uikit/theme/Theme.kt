...
fun PocketShellTheme(
    ...
    CompositionLocalProvider(
        // One scheme of semantic roles (dark dev-tool). The roles are colour
        // values from the existing palette, so they don't flip with the M3
        // light scheme (#112) — same reasoning as the raw [PocketShellColors]
        // tokens noted on [PocketShellLightColorScheme].
